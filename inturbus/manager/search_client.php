    ...
    <table class="table">
        ...
        <tr>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" style="width: 300px;">
                        <form class="px-1 py-3 mx-3" action="../core/admin_back/update.php" method="post">
                            ...
                            <!--скрытое поле-->
                            <button type="submit" class="btn btn-primary" style="display: block; margin: 0 auto;" name="update_client_m" value="<?= $row['id_cl']; ?>">Применить</button>
                        </form>
            ...
            <td>
                    ...
                    <form action="contract_cl.php" method="post"><button name="contract_cl" value="<?= $row['id_cl']; ?>" class="btn btn-primary" role="button" aria-disabled="true">Договор</button></form>
            </td>
            <td>
                <?php 
                    $client = $row['id_cl'];
